...
const COLUMNS: { key: ColumnKey; label: string }[] = [
  ...
  { key: "re_powder_qty", label: "Re-Powder Qty" },
  ...
  { key: "weightbar_one_qty", label: "1 Qty" },
...
const ENABLED_FLAGS: Record<string, ColumnKey> = {
  ...
  weightbar_one_qty: "weightbar_enabled",
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h4 className="text-lg font-semibold text-slate-900 dark:text-white">Powder Coat Packing Records</h4>
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                {filteredData.map((row, idx) => (
                  <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                    ...
                    <td className="px-2 py-2 whitespace-nowrap border-r border-slate-200 dark:border-slate-700">
